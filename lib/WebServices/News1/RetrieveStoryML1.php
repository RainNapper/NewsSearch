...
class WebServices_News1_RetrieveStoryML1 extends WebServices_AuthorizedSoapRequestorAbstract
{
	private $storyIDs;
	...
	{
		$storyRequest = new WebServices_News1_StoryMLNewsMLRequest();
		$storyRequest->StoryId = explode(PHP_EOL, $this->storyIDs);
		$storyRequest->TimeOut = $this->timeOut;
		$retval = new WebServices_News1_RetrieveStoryML1Request();
		$retval->StoryMLRequest = $storyRequest;
		return $retval;
	}
}