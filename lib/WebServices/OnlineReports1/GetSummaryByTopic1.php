...
class WebServices_OnlineReports1_GetSummaryByTopic1 extends WebServices_AuthorizedSoapRequestorAbstract
{
	private $topic;
	...
	{
		$retval = new WebServices_OnlineReports1_GetHeadlines1GetSummaryByTopic1Request();
		$retval->Topic = $this->topic;
		$retval->MaxCount = $this->maxCount;
		return $retval;
	}
}