...
class WebServices_TimeSeries1_GetExchangeData1 extends WebServices_AuthorizedSoapRequestorAbstract
{
	private $exchange;
	...
	{
		$retval = new WebServices_TimeSeries1_GetExchangeData1Request();
		$retval->exchange = $this->exchange;
		return $retval;
	}
